...
def compare_file(path: Path, timeout: int, delay: float) -> dict[str, Any]:
    ...
    return {
        ...
        "monic_enforced": local.get("monic_enforced"),
        "allow_nonmonic": local.get("allow_nonmonic"),
        "leading_representatives": local.get("leading_representatives"),
        "hasse_witt_prefilter": local.get("hasse_witt_prefilter"),
        "reduction_class_count": local.get("reduction_class_count"),
        "isomorphism_class_count": local.get("isomorphism_class_count"),
        "isomorphism_class_count_note": local.get("isomorphism_class_count_note"),
